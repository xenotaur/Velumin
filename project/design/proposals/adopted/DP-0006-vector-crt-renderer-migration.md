...
Follow-up under this adopted direction: the public preset API (adopted `DP-0007`) is implemented in `WI-PRESET-0001`, which also captured the non-default presets in the smoke check. The automatable/committed screenshot smoke check has landed (`WI-SMOKE-0001`, `scripts/smoke`).
