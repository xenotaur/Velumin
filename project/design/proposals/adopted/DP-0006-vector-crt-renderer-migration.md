...
Follow-up work under this adopted direction (tracked separately, not adoption prerequisites): whether the internal preset set becomes a selectable public API (`DP-0007`) and visual capture of the non-default presets. The automatable/committed screenshot smoke check has landed (`WI-SMOKE-0001`, `scripts/smoke`).
