...
- The public display-preset API (DP-0007 adopted 2026-07-25: a public `#[non_exhaustive]` `VectorDisplayPreset` selector at creation and runtime, named presets only in v1) is implemented in WI-PRESET-0001, which also captures the non-default presets in the smoke check.
