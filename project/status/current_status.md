...
- DP-0002 and DP-0003 remain proposed follow-up design directions. DP-0002's Phase 1 platform-neutral type extraction is now done ahead of full workstream selection: `WI-ARCH-0001` (PR #17) converted the repository into a Cargo workspace with a `velumin-core` crate holding vector/scene/style types, zero `wasm-bindgen`/`web-sys`/`wgpu` dependency.
