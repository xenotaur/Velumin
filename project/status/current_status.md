...
1. Create a focused follow-up work item/proposal for DP-0008 view/viewport mapping so browser games with full-window or arbitrary logical coordinate systems can submit `VectorFrame` / `&[VectorCommand]` data without ad hoc per-game coordinate conversion.
