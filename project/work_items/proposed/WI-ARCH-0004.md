...
acceptance:
  - DP-0002 Phase 2's milestone list no longer includes desktop-side adapter/capability negotiation as one of its own bullets, and its retained web-side negotiation bullet is marked done, citing Renderer::new (not WebGPU::create_with_preset) without asserting how a future Phase 3 desktop caller will reach it
...
## Acceptance Criteria
- DP-0002 Phase 2's milestone list no longer includes desktop-side adapter/capability negotiation as one of its own bullets, and its retained web-side negotiation bullet is marked done, citing `Renderer::new` (not `WebGPU::create_with_preset`) as the current location of the checks without asserting how a future Phase 3 desktop caller will reach them.
- DP-0002 Phase 3's milestone list explicitly includes desktop-side adapter/capability negotiation as one of its own bullets, with a note that it moved from Phase 2 on 2026-08-01.
