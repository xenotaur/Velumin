...
3. Decide whether to build DP-0007's deferred public custom display-settings API (the public preset API itself is implemented, `WI-PRESET-0001`). Scope a work item for DP-0002 Phase 2, now selected as the active workstream; Phase 3 (native `winit` shell) still awaits its own selection.
